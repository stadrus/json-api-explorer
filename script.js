// so much empty//
const postsList = document.getElementById("postList"); //4. get required element by ID.
...
const renderPosts = (posts) =>{ //create a function to display the data rendered from the fetched data
    postsList.innerHTML = "";
    posts.forEach((post) => {
